...
function runTests(){
    var i = 0,
        testPrefix = 'test',
        testPrefixEnc = encodeURIComponent(testPrefix);
    ...
    // same tests again, using a custom prefix
    {
        name: "test easyXDM.Socket{SameOriginTransport} with prefix",
        setUp: function(){
            this.expectedMessage = ++i + "_abcd1234%@¤/";
        },
        steps: [{
            ...
            run: function(){
                ...
                this.transport = new easyXDM.Socket({
                    prefix: testPrefix,
                    protocol: "4",
                    remote: LOCAL + "/test_transport.html?prefix=" + testPrefixEnc,
                    onMessage: function(message, origin){
                        if (scope.expectedMessage === message) {
                            if (++messages === 2) {
                                scope.notifyResult(true);
        ...
        name: "test easyXDM.Socket{PostMessageTransport} with prefix",
        runIf: function(){
            if (!("postMessage" in window || "postMessage" in document)) {
                return "This test requires the HTML5 postMessage interface.";
            }
        ...
        steps: [{
            ...
            run: function(){
                ...
                this.transport = new easyXDM.Socket({
                    ...
                    protocol: "1",
                    local: "../name.html",
                    remote: REMOTE + "/test_transport.html?prefix=" + testPrefixEnc,
                    onMessage: function(message, origin){
                        if (scope.expectedMessage === message) {
                            if (++messages === 2) {
                                scope.notifyResult(true);
        ...
        name: "test easyXDM.Socket{FlashTransport} with prefix",
        setUp: function(){
            this.expectedMessage = ++i + "_abcd1234%@¤/";
        },
        steps: [{
        ...
        name: "test easyXDM.Socket{FrameElementTransport} with prefix",
        runIf: function(){
            if (!(navigator.product === "Gecko" && "frameElement" in window && !("postMessage" in window) && navigator.userAgent.indexOf('WebKit') == -1)) {
                return "This test requires an older Gecko browser and the presence of the frameElement object";
            }
        ...
        name: "test easyXDM.Socket{NameTransport} with prefix",
        failedMessage: "This might fail in modern browsers due to restrictions in referencing existing windows",
        setUp: function(){
            this.expectedMessage = ++i + "_abcd1234%@¤/";
        },
        ...
        name: "test easyXDM.Socket{HashTransport} using window with prefix",
        setUp: function(){
            this.expectedMessage = ++i + "_abcd1234%@¤/";
        },
        tearDown: function(){
        ...
        name: "test easyXDM.Socket{HashTransport} with no blank local, available image and resize with prefix",
        failedMessage: "This might fail in modern browsers due to restrictions in referencing existing windows",
        setUp: function(){
            this.expectedMessage = ++i + "_abcd1234%@¤/";
            this.img = document.createElement("img");
        ...
        name: "test easyXDM.Socket{HashTransport} with s.gif and polling with prefix",
        failedMessage: "This might fail in modern browsers due to restrictions in referencing existing windows",
        setUp: function(){
            this.expectedMessage = ++i + "_abcd1234%@¤/";
        },
        ...
        name: "test easyXDM.Socket{HashTransport} with fragmentation (8192) with prefix",
        failedMessage: "This might fail in modern browsers due to restrictions in referencing existing windows",
        setUp: function(){
            var i = 11;
            this.expectedMessage = "aaaa";
        ...
        name: "test easyXDM.noConflict {SameOriginTransport} with prefix",
        setUp: function(){
            this.expectedMessage = ++i + "_abcd1234%@¤/";
        },
        steps: [{
            ...
            run: function(){
                ...
                this.transport = new modules.easyXDM.Socket({
                    prefix: testPrefix,
                    protocol: "4",
                    remote: LOCAL + "/test_namespace.html?prefix=" + testPrefixEnc,
                    onMessage: function(message, origin){
                        if (scope.expectedMessage === message) {
                            if (++messages === 2) {
                                scope.notifyResult(true);
        ...
        name: "test easyXDM.Socket{} with prefix",
        setUp: function(){
            this.expectedMessage = ++i + "_abcd1234%@¤/";
        },
        tearDown: function(){
        ...
        name: "test easyXDM.Socket{} using hash for passing data with prefix",
        setUp: function(){
            this.expectedMessage = ++i + "_abcd1234%@¤/";
        },
        tearDown: function(){
        ...
        steps: [{
            ...
            run: function(){
                ...
                this.transport = new easyXDM.Socket({
                    ...
                    local: "../name.html",
                    swf: REMOTE + "/../easyxdm.swf",
                    remote: REMOTE + "/test_transport.html?foo=bar?prefix=" + testPrefixEnc,
                    hash: true,
                    onMessage: function(message, origin){
                        scope.notifyResult((scope.expectedMessage === message));
                    },
        ...
        name: "test easyXDM.Socket{} with buffering with prefix",
        setUp: function(){
            this.expectedMessage = ++i + "_abcd1234%@¤/";
        },
        tearDown: function(){
        ...
        name: "test easyXDM.Socket{} with query parameters with prefix",
        setUp: function(){
            this.expectedMessage = ++i + "_abcd1234%@¤/";
        },
        tearDown: function(){
        ...
        steps: [{
            ...
            run: function(){
                ...
                this.transport = new easyXDM.Socket({
                    ...
                    local: "../name.html",
                    swf: REMOTE + "/../easyxdm.swf",
                    remote: REMOTE + "/test_transport.html?a=b&c=d&prefix=" + testPrefixEnc + "#foo,faa",
                    onMessage: function(message, origin){
                        scope.notifyResult((scope.expectedMessage === message));
                    },
                    onReady: function(){
        ...
        name: "test easyXDM.Rpc with prefix",
        setUp: function(){
            this.expectedMessage = ++i + "_abcd1234%@¤/";
        },
        tearDown: function(){
        ...
        steps: [{
            ...
            run: function(){
                ...
                this.remote = new easyXDM.Rpc({
                    ...
                    local: "../name.html",
                    swf: REMOTE + "/../easyxdm.swf",
                    remote: REMOTE + "/test_rpc.html?prefix=" + testPrefixEnc,
                    remoteHelper: REMOTE + "/../name.html",
                    container: document.getElementById("embedded"),
                    onReady: function(){
                        scope.notifyResult(true);
